...
function TempRecipe() {
    return(
        <div>
            <body className="recipe-page-body">

            {/* Hero */}
            <div className="recipe">
                <div>
                    <div className="recipe-page-hero">
                        <h1>Chocolate Red Wine Cupcakes</h1>
                        <p>These boozy red wine cupcakes are perfect for Valentine's day, girl's night, or just when you're bored on a Sunday afternoon, like I was when I first made them.</p>
                        <div className="pairing-list">
                        <p className="bold">Pairs with:</p>
                            <ul>
                                <li><i class="fa-solid fa-wine-glass"></i>Pizzella Malbec</li>
                                <li><i class="fa-regular fa-snowflake"></i>Cold days</li>
                                <li><i class="fa-regular fa-face-meh-blank"></i>General moodiness</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div className="recipe-step">
                        <div className="recipe-sub-step no-ingredients">
                            ...
                            <div>
                                ...
                                <p>Bake 16-20 minutes, until set. (Toothpick should come off with a few crumbs.)</p>
                    ...
                    <div className="recipe-step">
                        <div className="recipe-sub-step">
                            ...
                            <div>
                                ...
                                <p>Add powdered sugar 1 cup at a time. Add cream and vanilla.</p>
                                <p>Add red wine.</p>
